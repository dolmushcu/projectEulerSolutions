def func():
  ...
  def horizontal(row, col):
    ...
    for i in range(col, col + 10, 3):
      horizontal_product *= int(grid[row][i:i+2])
  ...
  def vertical(row, col):
    ...
    for i in range(row, row + 4):
      vertical_product *= int(grid[i][col:col+2])
  ...
  def right_diagonal(row, col):
    ...
    for i in range(4):
      right_diagonal_product *= int(grid[row + i][col+(i*3):col+(i*3)+2])
  ...
  def left_diagonal(row, col):
    ...
    for i in range(4):
      left_diagonal_product *= int(grid[row + i][col-(i*3):col-(i*3)+2])
